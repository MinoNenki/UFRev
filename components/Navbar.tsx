...
export default async function Navbar() {
  ...
  const dashboardLabel = tr(language, {
    en: 'Dashboard',
          ...
          <div className="flex flex-wrap items-center gap-2 lg:justify-end">
            ...
            {!isSupabaseConfigured ? (
              ...
              <>
                ...
                <LogoutButton label={tr(language,{en:'Log out',pl:'Wyloguj się',de:'Abmelden',es:'Cerrar sesión',pt:'Sair',ru:'Выйść'})} />
              </>
            ) : (
              <>
