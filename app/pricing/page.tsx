...
export default async function PricingPage() {
  ...
  return (
    <main className="mx-auto max-w-[1600px] px-3 py-6 text-white sm:px-0 sm:py-16">
      <section className="mesh-panel animate-aurora relative p-4 shadow-[0_30px_140px_rgba(2,6,23,0.65)] sm:p-8">
      ...
      <section className="mt-5 rounded-[24px] border border-cyan-300/20 bg-cyan-300/10 p-4 md:hidden">
        ...
        <div className="mt-3 grid gap-2 text-sm text-slate-100">
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-950/45 px-3 py-3">{tr(language, { en: 'Scale = advanced team workflow', pl: 'Scale = zaawansowany workflow zespołu' })}</div>
        </div>
      </section>

      <section className="mt-4 grid gap-3 md:hidden">
        {primaryPlans.map((plan) => (
          <div key={`mobile-${plan.key}`} className="rounded-[24px] border border-white/10 bg-slate-950/60 p-4 shadow-[0_18px_60px_rgba(2,6,23,0.35)]">
            <div className="flex items-center justify-between gap-2">
              <div className="text-[11px] uppercase tracking-[0.22em] text-cyan-200">{plan.name}</div>
              <div className="text-3xl font-black text-white">{plan.priceLabel}</div>
            </div>
            ...
            {plan.key === 'free'
              ...
              : <PricingCheckoutButton
                  ...
                  checkoutLabel={tr(language, { en: 'Choose this plan', pl: 'Wybierz plan' })}
      ...
      >
        ...
        >
          ...
          <div className="pricing-video-weight-panel mt-6 hidden rounded-[28px] border border-cyan-300/16 p-5 shadow-[0_24px_80px_rgba(8,47,73,0.22)] sm:p-6 md:block">
          ...
          <div className="mt-6 hidden gap-6 xl:grid-cols-2 md:grid">
          ...
          <details className="mt-8 hidden rounded-[28px] border border-white/10 bg-white/[0.03] p-5 md:block">
        ...
        >
          <details className="mb-6 hidden rounded-[28px] border border-amber-300/20 bg-amber-300/10 p-5 text-sm leading-7 text-amber-50 md:block">
