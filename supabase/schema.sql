...
drop policy if exists "Users can read public ad provider list" on public.ad_providers_config;
...
drop policy if exists "Users can delete own ad accounts" on public.user_ad_accounts;
...
drop policy if exists "Users can update own ad impressions" on public.ad_impressions;
